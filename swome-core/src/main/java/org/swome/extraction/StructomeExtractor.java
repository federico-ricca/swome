...
import org.swome.impl.groovy.GroovyClassDependencyGraphBuilder;
...
public class StructomeExtractor {
	class ExtractionConfiguration {
		...
		public GroovyClassDependencyGraph graphFactory;
	}
	...
	public Structome processFolder(String _path) {
		...
		for (String _confKey : configurations.keySet()) {
			ExtractionConfiguration _configuration = configurations
					.get(_confKey);
			...
			Graph<GroovyClassArtefact, ClassReferenceRelation> _graph = _configuration.builder
					.buildFrom(_fileArtefacts, _configuration.factory, null);
	...
	public void registerGraph(String _graphId, String _filenameRegex,
			GroovyClassDependencyGraphBuilder _builder,
			GroovyClassArtefactFactory _factory) {
